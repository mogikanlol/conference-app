...
export class UserService {
  ...
  getReviewableConferences(): Observable<Map<number, boolean>> {
    ...
    return this.http.get<Array<Conference>>(this.url + this.userId + '/conferences', {params: params}).pipe(map((conferences: Array<Conference>) => {
  ...
  getUsers(page: number = 0, searchString?: string): Observable<Page<BriefUser>> {
    ...
    return this.http.get<Page<BriefUser>>(this.url.substring(0, this.url.length - 1) + '?page=' + page, {params: params});
  }
